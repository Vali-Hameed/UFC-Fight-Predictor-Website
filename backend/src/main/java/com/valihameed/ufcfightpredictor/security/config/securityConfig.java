...
public class securityConfig{
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .requestMatchers(HttpMethod.GET, "/api/v*/fighters/**", "/api/v*/events/**", "/api/v*/leaderboard/**", "/api/v*/forum/**", "/api/v*/community-votes/**", "/api/v*/ml/**", "/api/v*/health", "/api/v*/users/*", "/api/v*/stats/**").permitAll()
