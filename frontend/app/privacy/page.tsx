export const metadata = {
  title: "Privacy Policy | FightPicks",
  description: "Privacy Policy for FightPicks",
};
      ...
      <div className="rounded-2xl border border-white/10 bg-white/5 p-8 shadow-xl backdrop-blur-sm sm:p-12">
        ...
        <div className="space-y-8 text-white/70">
          <section>
            ...
            <p>
              Welcome to FightPicks. We respect your privacy and are committed to protecting your personal data. 
