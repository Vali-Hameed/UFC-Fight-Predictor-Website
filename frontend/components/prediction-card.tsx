      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <div className="flex items-center gap-3">
            ...
            {fight.liveStatus && (fight.liveStatus.includes("IN_PROGRESS") || fight.liveStatus.includes("END_PERIOD") || fight.liveStatus.toUpperCase().includes("WALK")) && fight.status !== "COMPLETED" && (
